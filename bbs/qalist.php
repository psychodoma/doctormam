...
//$branchName = get_branch($member['mb_id'],"branch");
...
//echo $sql ;
	...
	if($member["mb_level"] > 5){
		$is_admin = "visor";
		$view_href = G5_BBS_URL.'/qaview.php';
	};
    ...
    $list_pages = preg_replace('/(\.php)(&amp;|&)/i', '$1?', get_paging2(G5_IS_MOBILE ? $qaconfig['qa_mobile_page_rows'] : $qaconfig['qa_page_rows'], $page, $total_page, './qalist.php'.$qstr.'&amp;page='));
