...
if ($file_upload_msg)
    ...
    if($bo_table == "reservation"){
        ...
        if($w == "" ||$w == "r"){
            ...
            //send_sms('010-6749-3133','010-6749-3133',$sms_content,$wr_id);
            $sms_content2 = $wr_name." 고객님 연락처 ".$wr_hp0." 닥터맘 온라인 예약접수.";
            //send_sms('010-6749-3133','010-6749-3133',$sms_content2,$wr_id);
        }
        alert("예약이.");
        goto_url(G5_URL."/");
        ...
        //send_sms('010-6749-3133','010-4527-8604' ,$sms_content2);
		alert("접수 되었습니다.");
        goto_url(G5_URL."/");
    }else{
