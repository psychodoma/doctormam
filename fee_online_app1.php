...
<?php include_once(G5_PATH.'/SNB.php'); ?>
            <div class="sub_cont1">
                ...
                <div class="s_cont">
                    ...
                    <form method="post"  id="fwrite" name="fwrite" action="<?php echo G5_BBS_URL?>/write_update1.php" onsubmit="return fwrite_submit(this);" class="sub4_1_fc" enctype="multipart/form-data">
                            ...
                            <table class="sub4_1_table" summary="이름 사는지역 연락처를 작성해주세요">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="sub4_1_coop">
                                            <li>
                                                <?php echo radio_selected("wr_service_type","1",$write['service_type'],"베이직"); ?>
                                            </li>
                                            <li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="sub4_1_cctv">
                                            ...
                                            <li>
                                                <input type="text" class="sub4_1_input" title="아이디입력" name="wr_mate[]" id="wr_mate_3"/>
