...
<div class="tab_m">
  <button class="tablinks_m active" id='all_m'>100일</button>
  <button class="tablinks_m" id='pro_100_d_m'>첫돌</button>
  <button class="tablinks_m" id='pro_1_y_m'>이벤트</button>
</div>

<br><br>
문자발송시 보내실 내용을 입력해주세요.
<br><br>
<form action='/adm/promotion_message_update.php' method='post'>

<div id="" class="tabcontent_m all_m" >
<textarea name="editor1" id="editor1" rows="10" cols="80" style='width:98.8%;'>
<?=$por_value['pro_message_100'];?>
</textarea>
</div>



<div id="" class="tabcontent_m pro_100_d_m">
<textarea name="editor2" id="editor2" rows="10" cols="80" style='width:98.8%;'>
<?=$por_value['pro_message_1'];?>
</textarea>
</div>

<div id="" class="tabcontent_m pro_1_y_m">
<textarea name="editor3" id="editor3" rows="10" cols="80" style='width:98.8%;'>
<?=$por_value['pro_message_event'];?>
</textarea>
</div>
<br>
<input type='hidden' name='pro_type' id='pro_type' value='all_m'>
<button type='submit' class='btn' style='float:right;width:120px; height:40px; border:none; background:#373333; color:white;'>저장하기</button>
</form>
...
$('.tablinks_m').click(function(){
    $('.tablinks_m').removeClass('active');
    $(this).addClass('active');
    $('.tabcontent_m').css('display','none');
    $('.'+$(this).attr('id')).css('display','block');
    $('#pro_option_m').attr('value',$(this).attr("id"));
    $('#pro_type').attr('value',$(this).attr('id'));
    
})

<?if($pro_option_m == 'all_m'){?>
    $('.tabcontent_m').css('display','none');
    $('.all_m').css('display','block');
<?}?>

<?if($pro_option_m == 'pro_100_d_m'){?>
    $('.tabcontent_m').css('display','none');
    $('.pro_100_d_m').css('display','block');
<?}?>

<?if($pro_option_m == 'pro_1_y_m'){?>
    $('.tabcontent_m').css('display','none');
    $('.pro_1_y_m').css('display','block');
<?}?>
</script>   
