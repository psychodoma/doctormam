...
$g5['title'] = "문자전송중";
$q_str = "";
if(!empty($_REQUEST["referer_param"]) ){
    $q_str = "&".$_REQUEST["referer_param"];
}
...
if($config['cf_sms_type'] == 'LMS') {
    ...
    if($port_setting !== false) {
        ...
        sql_query("insert into {$g5['sms5_write_table']} set wr_no='$wr_no', wr_renum=0, wr_reply='$wr_reply', wr_message='$wr_message', wr_success='$wr_success', wr_failure='$wr_failure', wr_memo='$str_serialize', wr_booking='$wr_booking', wr_total='$wr_total', wr_datetime='".G5_TIME_YMDHIS."', wr_fore_key='".$_REQUEST["wr_fore_key"]."', wr_fore_type='".$_REQUEST["wr_fore_type"]."', wr_branch='". $member["mb_no"]  ."'");
    }
} else {
...
act = window.open('sms_ing.php', 'act', 'width=300, height=200');
act.close();
location.href = 'history_view.php?wr_no=<?php echo $wr_no?><?php echo $q_str ?>';
</script>
<?php
