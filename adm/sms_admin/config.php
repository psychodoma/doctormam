...
<div class="tbl_frm01 tbl_wrap" >
    <iframe src="http://www.icodekorea.com/smsbizinfo_new/" style="width:100%;height:180px;"></iframe>
</div>
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="button" value="충전하기" class="btn_frmline_add" onclick="window.open('http://icodekorea.com/company/credit_card_input.php?icode_id=<?php echo $config['cf_icode_id']?>&icode_passwd=<?php echo $config['cf_icode_pw']?>','icode_payment','width=650,height=500')">
        </td>
    </tr>
    <?php } ?>
    <tr>
...
<div class="btn_confirm01 btn_confirm" style="display:none;">
