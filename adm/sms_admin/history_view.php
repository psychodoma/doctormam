...
<div id="sms5_sent">
    ...
    <div class="btn_add01 btn_add">
         <?php if(!empty($_REQUEST["bo_table"])){?>
        <a href="<?php echo G5_ADMIN_URL ?>/dr_write.php?bo_table=<?php echo $_REQUEST["bo_table"] ?>&w=u&wr_id=<?php echo $_REQUEST["wr_id"] ?>">이전 페이지</a>
        <?php } ?>
