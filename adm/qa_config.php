...
<section id="anc_cf_qa_config">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="qa_title" value="<?php echo $qaconfig['qa_title'] ?>" id="qa_title" required class="required frm_input" size="40" style="background:none !important;">
                <a href="<?php echo G5_BBS_URL; ?>/qalist.php" class="btn_frmline_add">1:1문의 바로가기</a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="qa_category" value="<?php echo $qaconfig['qa_category'] ?>" id="qa_category" required class="required frm_input" size="70" style="background:none !important;">
            </td>
        </tr>
        <tr>
