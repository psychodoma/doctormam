...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl" class="adm_sel1 ">
        <option value="wr_name"<?php echo get_selected($sfl, 'wr_name', true); ?>>지원자</option>
        <option value="wr_content"<?php echo get_selected($sfl, 'wr_content'); ?>>연락처</option>
    </select>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php } ?>
            <td class="td_branch sv_use"><?php echo get_branch($list[$i]['branch']); ?></td>
			<td class="td_wr_name sv_use"> 
				<a href="<?php echo $list[$i]['href'] ?>"><strong><?php echo $list[$i]['name'] ?></strong>님 산후관리사 지원</a>
			</td>
			<td class="td_content"><?php echo $list[$i]['wr_content'] ?></td>
