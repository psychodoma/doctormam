...
<fieldset id="bo_sch" style="float:right;margin-bottom:15px;">
    ...
    <select name="sfl" id="sfl" class="adm_sel1 ">
        <option value="wr_subject_ck"<?php echo get_selected($sfl, 'wr_subject_ck', true); ?>>제목</option>
        <option value="wr_content"<?php echo get_selected($sfl, 'wr_content'); ?>>내용</option>
        <option value="wr_subject_ck||wr_content"<?php echo get_selected($sfl, 'wr_subject_ck||wr_content'); ?>>제목+내용</option>
    </select>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php if ($is_checkbox) { ?>
            <td class="td_chk">
                <label for="chk_wr_id_<?php echo $i ?>" class="sound_only"><?php echo $list[$i]['wr_subject_ck'] ?></label>
