...
<section id="bo_v_ans">
    <?php
    if($is_admin || $member["mb_level"] > 6) // 관리자이면 답변등록
    {
    ?>
    <h2>답변등록</h2>

    <form name="fanswer" method="post" action="./dr_qawrite_update.php" onsubmit="return fwrite_submit(this);" autocomplete="off">
