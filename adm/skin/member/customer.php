...
<form id="fsearch" name="fsearch" class="local_sch01 local_sch" method="get">
    <div class="search_form">
        ...
        <input type="text" name="stx" value="<?php echo $stx ?>" id="stx" required class="required frm_input" style="background:none;">
    ...
    <div class="tbl_head02 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <!--<th scope="col" id="mb_list_sms"><?php /*echo subject_sort_link('mb_sms', 'member_type='.$member_type, 'desc') */?>SMS<br>수신</a></th>-->
                <th scope="col" id="mb_list_join"><?php echo subject_sort_link('mb_datetime', 'member_type='.$member_type, 'desc') ?>가입일</a></th>
                <th scope="col" id="mb_list_ip">아이피<?php echo subject_sort_link('mb_ip', 'member_type='.$member_type, 'desc') ?></a></th>
            </tr>
            </thead>
            <tbody>
            <?php
            for ($i=0; $row=sql_fetch_array($result); $i++) {
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td headers="mb_list_branch" class="td_name sv_use"><a href="./dr_member_form.php?<?php echo $qstr ?>&w=u&mb_id=<?php echo $row['mb_id']?>"><?php echo ($row['branch_name']) ?></a></td>
                    ...
                    <td headers="mb_list_ip" class="td_tel"><a href="./dr_member_form.php?<?php echo $qstr ?>&w=u&mb_id=<?php echo $row['mb_id']?>"><?php echo get_text($row['mb_ip']); ?></a></td>
                </tr>
                <?php
            }
            if ($i == 0)
