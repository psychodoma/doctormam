...
<form name="fsearch" id="fsearch" class="local_sch01 local_sch" method="get" style="float:left; margin: 7px 0 0 0;">
...
<div class="btn_add01 btn_add" style="float:right;">
    <a href="./board_form.php" id="bo_add" style="padding:0 15px;">게시판 추가</a>
</div>
<?php } ?>
