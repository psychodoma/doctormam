...
if ($w == 'u') $frm_submit .= '<a href="./board_copy.php?bo_table='.$bo_table.'" id="board_copy" target="win_board_copy">게시판복사</a>
    <a href="'.G5_BBS_URL.'/board.php?bo_table='.$board['bo_table'].'" class="btn_frmline" style="padding:0;">게시판 바로가기</a>
    <a href="./board_thumbnail_delete.php?bo_table='.$board['bo_table'].'&amp;'.$qstr.'" onclick="return delete_confirm2(\'게시판 썸네일 파일을 삭제하시겠습니까?\');" style="padding:0px 15px;">게시판 썸네일 삭제</a>'.PHP_EOL;
$frm_submit .= '</div>';
?>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $board['bo_table'] ?>" class="btn_frmline_add">게시판 바로가기</a>
                    <a href="./board_list.php" class="btn_frmline_add">목록으로</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <?php if ($w=='u') { ?><a href="javascript:document.location.href='./board_list.php?sfl=a.gr_id&stx='+document.fboardform.gr_id.value;" class="btn_frmline_add">동일그룹 게시판목록</a><?php } ?></td>
            </td>
        </tr>
        <tr>
