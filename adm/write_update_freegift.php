...
if($w == 'p'){
	sql_query("update g5_write_freegift set wr_3 = '".$wr_3."' where wr_id =".$wr_id);
	goto_url("/adm/dr_board.php?bo_table=freegift&pro_option=all&pro_option_m=all_m");
}
...
if ($file_upload_msg)
    ...
    goto_url(G5_ADMIN_URL.'/dr_board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.$qstr."&p=1");
?>
