...
//성별
$mb_sex_yes        =  $mb['mb_sex']       ? 'checked="checked"' : '';
$mb_sex_no         = !$mb['mb_sex']       ? 'checked="checked"' : '';
...
if(!empty($mb['mb_fax'])){
    ...
    $fax_arr = explode("-",$mb['mb_fax']);
    $mb_fax1 = $fax_arr[0];
    $mb_fax2 = $fax_arr[1];
    $mb_fax3 = $fax_arr[2];
}
if(!empty($mb['mb_tel'])){
    $tel_arr = explode("-",$mb['mb_tel']);
    $mb_tel1 = $tel_arr[0];
    $mb_tel2 = $tel_arr[1];
    $mb_tel3 = $tel_arr[2];
}
...
if($member_type == "3"){
    include_once('./skin/member/customer_form.php');
}else if($member_type == "5"){
    include_once('./skin/member/manager_form.php');
}else if($member_type == "7" || $member_type == "9"){
    include_once('./skin/member/branch_form.php');
}
?>
