...
<form name="fsearch" id="fsearch" class="local_sch01 local_sch" method="get" style="float:left; width:500px; min-width: inherit; margin-bottom: 0; margin-top: 6px;">
...
<input type="text" name="stx" value="<?php echo $stx ?>" required class="required frm_input" style="background:none !important;">
<input type="submit" value="검색" class="btn_submit">
</fieldset>
</form>

<?php if ($is_admin == 'super') { ?>
<div class="btn_add01 btn_add sort_with" style="float:right;">
    <a href="./boardgroup_form.php" id="bo_gr_add" style="width:100px; display: inline-block;">게시판그룹 추가</a>
</div>
<?php } ?>
...
<div class="btn_list01 btn_list">
    ...
    <a href="./boardgroup_form.php" class="" style="width:100px; display: inline-block; height:36px;">게시판그룹 추가</a>
</div>
</form>
