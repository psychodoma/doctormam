...
<div id="headerBG_m">
	<h1 class="logo_m"><a href="/"><img src="<?php echo G5_MOBILE_IMG ?>/main/m_logo.jpg" alt="에넥스 로고"/></a></h1>
					...
					<nav>
						<ul class="f_line_top">
							...
							<ul class="sub_ul" id="menu1">
								...
								<!--<a class="bodr0" href="<?php echo G5_MOBILE_URL ?>/intro_office.php"><li class="sgm">시설보기</li></a>-->
							</ul>
							...
							<ul class="sub_ul" id="menu3">
								<a class="bodr1" href="<?php echo G5_MOBILE_URL ?>/service_basic.php"><li class="sgm">닥터맘 베이직</li></a>
								<a class="" href="<?php echo G5_MOBILE_URL ?>/service_best.php"><li class="sgm">닥터맘 베스트</li></a>
								<a class="bodr1" href="<?php echo G5_MOBILE_URL ?>/service_premium.php"><li class="sgm">닥터맘 프리미엄</li></a>
								<a class="" href="<?php echo G5_MOBILE_URL ?>/service_signiture.php"><li class="sgm">닥터맘 명품플러스</li></a>
								<a class="bodr1" href="<?php echo G5_MOBILE_URL ?>/service_global.php"><li class="sgm">닥터맘Global Service</li></a>
								<a class="" href="<?php echo G5_MOBILE_URL ?>/service_voucher.php"><li class="sgm">바우처</li></a>
								<a class="bodr1" href="<?php echo G5_MOBILE_URL ?>/service_terms.php"><li class="sgm">이용약관</li></a>
							</ul>
							...
							<li class="menu7 small_menu">
								<p class="bgm">커뮤니티</p>
							</li>
							<ul class="sub_ul" id="menu7">
								...
								<a class="" href="/bbs/board.php?bo_table=review"><li class="sgm">닥터맘 뉴스</li></a>
...
<script>
	...
	<div class="sub_cont1" style="float:none;margin:0 auto;width:100%;">
