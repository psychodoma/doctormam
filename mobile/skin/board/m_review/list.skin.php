                    ...
                    <?php } ?>
						<li>
							...
							<select title="검색 분류 선택" name="sfl" id="sfl" class="sub5_1_select" style="width:75px;">
								<option value="wr_subject_ck"<?php echo get_selected($sfl, 'wr_subject', true); ?>>제목</option>
                                <option value="wr_subject_ck"<?php echo get_selected($sfl, 'wr_subject_ck'); ?>>내용</option>
                                <option value="wr_subject||wr_subject_ck"<?php echo get_selected($sfl, 'wr_subject||wr_subject_ck'); ?>>제목+내용</option>
							</select>
							<?}else{?>
							<select title="검색 분류 선택" name="sfl" id="sfl" class="sub5_1_select" style="width:75px;">
