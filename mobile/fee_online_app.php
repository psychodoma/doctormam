    ...
    $( function() {
		...
		<div class="msub_container">
			<div class="sub4_select">
				<h3 class="sub3_5_tc_title mb30">산후도우미 예약하기</h3>
				...
				<form method="post"  id="fwrite" name="fwrite" action="<?php echo G5_BBS_URL?>/write_update.php" onsubmit="return fwrite_submit(this);" class="sub4_1_fc" enctype="multipart/form-data">
						...
						<table class="sub4_1_table" summary="이름 사는지역 연락처를 작성해주세요">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="sub4_1_input" title="아이디입력" name="wr_name" id="wr_name" onkeyup="CheckChange();" required minlength="2" maxlength="20" /></td>
								</tr>
								<tr>
									<th>전화번호</th>
									<td>
									<ul class="sub4_1_tell">
										<li>
											...
											<?php echo get_phone_select("wr_hp1",$wr_hp1,'required class="sub4_1_select" onchange="CheckChange();" ') ?>

										</li>
										<li>
											<span class="hypn">-</span>
											<input type="text" class="sub4_1_input_tell" title="두번째 자리" name="wr_hp2" id="wr_hp2" onkeyup="CheckChange();" maxlength="4" /><span class="hypn">-</span>
											<input type="text" class="sub4_1_input_tell" title="마지막 자리" name="wr_hp3" id="wr_hp3" onkeyup="CheckChange();" required maxlength="4" />
										</li>
										<li>
											<input style="margin:3px 0 0 0;" type="button" value="회원검색" onclick="SearchMember()"class="sub4_1add_btn"><span class="desc_dup"></span>
										</li>
									</ul>
								</td>
								</tr>
								<tr>
									<th>생년월일</th>
									<td><input type="text" class="sub4_1_input" title="아이디입력" name="wr_birth" id="wr_birth"maxlength="20" placeholder="1980-12-17"/></td>
								</tr>
								<tr>
									<th>이메일</th>
								...
								<tr>
									...
									<td>
										<ul class="sub4_1_add">
											<li>
												<input type="text" class="sub4_1_input_s" title="아이디입력" name="wr_zip" id="wr_zip" maxlength="6" readonly="readonly"/>
												<input type="button" value="주소검색" class="sub4_1add_btn" onclick="win_zip('fwrite', 'wr_zip', 'wr_addr1', 'wr_addr2', 'wr_addr3', 'wr_addr_jibeon');"/>
											</li>
											<li>
												<input type="text" class="sub4_1_input_ab" title="기본주소" name="wr_addr1" id="wr_addr1" readonly="readonly"/><span class="sub4_1addTxt">기본주소</span>
											</li>
											<li>
												<input type="text" class="sub4_1_input_ab" title="나머지주소" name="wr_addr2" id="wr_addr2"/><span class="sub4_1addTxt">나머지주소</span>
								...
								<tr>
									<th>분만예정일</th>
									<td><input type="text" id="wr_estimate" name="wr_estimate" readonly maxlength="20" ></td>
								</tr>

                                <tr>
                                    <th>문자수신</th>
                                    <td>
                                        <p class="sub41_sms sub41_sms1"><input type="checkbox" id='promotion' name="pro_100_d" value="1">&nbsp;100일 축하 메시지</p>
                                        <p class="sub41_sms sub41_sms1"><input type="checkbox" id='promotion1' name="pro_1_y" value="1">&nbsp;첫돌 축하 메시지</p>
                                        <p class="sub41_sms"><input type="checkbox" name="pro_event" value="1">&nbsp;이벤트 메시지</p>
                                    </td>
                                </tr>
								...
								<tr>
									<th>서비스시작일</th>
									<td><!-- <label for="wr_service_start">시작일 : </label><input type="text" id="wr_service_start" name="wr_service_start"readonly maxlength="20" style="margin-bottom:5px;"></br></br> -->
	                                        <ul class="sub4_1_coop"> 
												<li class="sub41_serviceChek"><label for="wr_service_period">기간 : </label></li>
												<li class="sub41_serviceChek">
					...
					<fieldset class="fild_1">
						...
						<textarea name="개인정보 수집 이용안내" id="" cols="" rows="10" class="fild_1_tex" readonly="readonly">닥터맘 이용약관 제 15조【 개인정보보호 】
...
③ ‘닥터맘’은 개인정보 보호를 위하여 개인정보보호 책임자를 지정 운영합니다.</textarea>
					...
					<fieldset class="fild_1">
						...
						<label for="wr_content" class="fild_1_title">기타문의</label>
						<textarea name="wr_content" id="wr_content" cols="" rows="8" class="fild_1_tex"></textarea>
					</fieldset>



					<ul class="sub4_1_1_list_btn">
						<li class="fl_right"><input type="submit" value="신청" /></li>
