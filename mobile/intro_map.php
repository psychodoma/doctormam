		...
		<div class="m_wrap">
			<div class="msub_container">
					...
					<ul class="sub1_5_loca">
						<li class="loca_li">
							<div class="loca_icon"><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/map_icon1.jpg" alt=""/></div>
							<div class="loca_info">
						...
						<li class="loca_li">
							<div class="loca_icon"><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/map_icon2.jpg" alt=""/></div>
							<div class="loca_info">
								<h4 style="padding-top:0; color:#5185be;">지하철</h4>
								<p class="loca_txt_strong">9호선 증미역 4번 출구, 9호선 가양역 6번 출구</p>
								<p class="loca_txt">9호선 증미역 4번출구로 직진하셔서 맥도날드,<br/>KIA자동차 건물 사이 골목으로 직진 강영빌딩 4층에 위치해 있습니다.</p>
							</div>
						</li>
						
						<!--
						<li class="loca_li">
							<div class="loca_icon"><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/map_icon3.jpg" alt=""/></div>
							<div class="loca_info">
								<h4 style="color:#2a5486;">버스</h4>
								<ul class="loca_bus">
									<li class="loca_txt_strong">내방역 3번출구(22-389)<span class="txt_normal">마을서초 07,서초 15</span></li>
									<li class="loca_txt_strong">제일병원(22-836)<span class="txt_normal">마을서초 07,서초 15</span></li>
									<li class="loca_txt_strong">내방역 2번출구(22-230)<span class="txt_normal">간선 142, 148, 406 / 지선4319</span></li>
								</ul>
							</div>
						</li>
						-->
						...
						<!--
						<li class="loca_li">
							<div class="loca_icon"><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/map_icon4.jpg" alt=""/></div>
							<div class="loca_info">
								<h4 style="color:#27354f;">주차장 이용안내</h4>
								<p class="loca_add mb20">닥터맘 건물 주차장을 무료로 이용하실 수 있습니다.</p>
								<p><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/sub1_5_map2.jpg" alt=""/></p>
							</div>
						</li>
						-->

						<li class="loca_li">
							<div class="loca_icon"><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/map_icon5.jpg" alt=""/></div>
							<div class="loca_info">
								<h4 style="padding-top:13px; color:#c0691d;">주변안내</h4>
								<p class="loca_add mb20">주변안내를 좀 더 자세히 해드리겠습니다.</p>
								<p><img src="<?php echo G5_MOBILE_IMG ?>/sub1/sub1_5/sub1_5_map3.jpg" alt=""/></p>
							</div>
						</li>
					</ul>
			</div>
