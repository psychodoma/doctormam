...
<?php include_once(G5_PATH.'/SNB.php'); ?>
            <div class="sub_cont1">
                <h3 class="subpage_name">닥터맘 일반형(정부지원/바우처)</h3>
                <p class="subpage_slog"><img src="img/sub1/sub1_4/sub1_4_banner1.jpg" alt="사랑스런 아이의 모습 오랜돔동으로 간직할 수 있는 서비스로 만들어 드리겠습니다."/></p>

                <div class="s_cont">
                    <h3><img src="img/sub3/basic_title.jpg" alt="베이직서비스란?"></h3>
                    <p class="sub3_imgTxt0"><img src="img/sub3/basic_title1.jpg" alt="기본교육 60시간을 이수하고 산후관리근무 경력이 800시간 미만인 산후관리사가 파견되어 편안한 서비스를 제공"></p>

                    <div class="sub3_service">

                        <div class="sub3_cont">
                            <h3 class="sub3_stitle"><img src="img/sub3/sub3_title1.jpg" alt="산후 회복 케어 프로그램"></h3>
                            <p class="sub3_imgTxt1" style='font-size:14px;' >* 프로그램의 횟수는 지사마다 다를 수 있습니다.</p>
                                ...
                                <ul class="sub3_contents_l">
                                    ...
                                    <li>
                                        <ul class="sub3_conIn">
                                            ...
                                            <li class="sub3_con_txt" style='color: #731a1a;' >* 자연분만시 복부,팔다리, 유방케어 중 택1<br>
														...
														<p class="sub3_imgTxt1" style='font-size:14px;' ></p>
