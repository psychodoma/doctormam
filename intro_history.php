...
<?php include_once(G5_PATH.'/SNB.php'); ?>
            <div class="sub_cont1">
                <h3 class="subpage_name">인사말 및 연혁</h3>
                <p class="subpage_slog"><img src="img/sub1/sub1_4/sub1_4_banner1.jpg" alt="사랑스런 아이의 모습 오랜돔동으로 간직할 수 있는 서비스로 만들어 드리겠습니다."/></p>

                <div class="s_cont">
                    <h4 class="sub1_1_img1"><img src="img/sub1/sub1_1/sub1_1_intro.jpg" alt=""/></h4>
                    <p class="sub1_1_img2"><img src="img/sub1/sub1_1/sub1_1_history.jpg" alt=""/></p>
                </div>
            </div>
